...
export function ExecutiveCard({
  ...
  return (
    <div className="relative flex h-full min-h-[152px] flex-col overflow-hidden rounded-2xl border border-emerald-500/25 bg-gradient-to-b from-emerald-500/10 via-zinc-950/40 to-zinc-950/30 p-4 shadow-sm">
      ...
      <div className="mt-3 flex-1 text-sm leading-6 text-zinc-300">{description}</div>
